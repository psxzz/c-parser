...
abstract class ConstantExp extends Exp

case class IntConstantExp(value: Int) extends ConstantExp

case class BoolConstantExp(value: Boolean) extends ConstantExp
